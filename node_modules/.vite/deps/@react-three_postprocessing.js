...
var KawaseBlurPass = class extends Pass {
  ...
  render(renderer, inputBuffer, outputBuffer, deltaTime, stencilTest) {
    ...
    for (let i2 = 0, l = kernelSequence.length; i2 < l; ++i2) {
      const buffer = (i2 & 1) === 0 ? renderTargetA : renderTargetB;
...
var ASCII = (0, import_react.forwardRef)(
  ({ characters = ` .:,'-^=*+?!|0#X%WM@`, fontSize = 54, cellSize = 16, color: color2 = "#ffffff", invert = false }, fref) => {
    const effect = (0, import_react.useMemo)(
      () => new ASCIIEffect({ characters, fontSize, cellSize, color: color2, invert }),
      [characters, fontSize, cellSize, color2, invert]
    );
...
var $87431ee93b037844$var$bluenoiseBits = Uint8Array.from(atob($06269ad78f3c5fdf$export$2e2bcd8739ae039), (c2) => c2.charCodeAt(0));
...
var $87431ee93b037844$export$2489f9981ab0fa82 = class extends Pass {
  ...
  constructor(scene, camera, width = 512, height = 512) {
    ...
    this.effectCompisterQuad = new FullScreenQuad(new ShaderMaterial($12b21d24d1192a04$export$a815acccbd2c9a49));
    this.copyQuad = new FullScreenQuad(new ShaderMaterial({
      uniforms: {
        tDiffuse: {
          value: null
        }
  ...
  configureAOPass(logarithmicDepthBuffer = false) {
    ...
    if (this.effectShaderQuad) {
      ...
      this.effectShaderQuad = new FullScreenQuad(new ShaderMaterial(e));
  }
  configureDenoisePass(logarithmicDepthBuffer = false) {
    ...
    if (this.poissonBlurQuad) {
      ...
      this.poissonBlurQuad = new FullScreenQuad(new ShaderMaterial(p));
  }
  /**
       * 
       * @param {Number} n 
...
Uint8Array.from(atob($06269ad78f3c5fdf$export$2e2bcd8739ae039), (c2) => c2.charCodeAt(0));
